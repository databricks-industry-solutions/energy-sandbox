...
| [**Drilling Command Center**](drilling-command-center/) | Ten-tab OSDU-backed subsurface and drilling command center on Azure Data Manager for Energy (ADME). Live Wellbore, Reservoir, and Rock & Fluid records, 3D digital twin, petrophysical log viewer, economics, governance, and a floating Genie chat for cross-domain queries. | Databricks Apps, FastAPI, React, Lakebase, Foundation Model API, ADME, Genie |
