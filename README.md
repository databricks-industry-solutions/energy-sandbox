...
A collection of Databricks solution accelerators for the **upstream oil & gas** industry. Each project demonstrates end-to-end data engineering, real-time analytics, and AI capabilities on the Databricks Lakehouse Platform.
