...
const dLat = (mi) => mi * 0.0145;
const dLon = (mi) => mi * 0.0170;
// ------------------------------------------------------------------
...
function createPads() {
    return [
        ...
        { id: 'PAD-D1', name: 'Delta Pad', lat: BASE_LAT - dLat(1), lon: BASE_LON + dLon(1.5), facilityId: 'FAC-CPF', wellIds: ['W-D01', 'W-D02', 'W-D03', 'W-D04', 'W-D05', 'W-SWD01'] },
    ];
}
// ------------------------------------------------------------------
// Facilities
...
// ------------------------------------------------------------------
function calculateKPIs(wells, facilities, flares) {
